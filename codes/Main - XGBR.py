...
for i in dep:
    ...
    for tr_i, ts_i in rkf.split(data):
        ...
        model = XGBRegressor(n_estimators=50, max_depth=i)
...
df.to_csv('C:\\Users\\Preetham G\\Documents\\Research Projects\\Ensemble Rainfall\\Results\\Main - XGB - Max Depth 1.csv', index=False)