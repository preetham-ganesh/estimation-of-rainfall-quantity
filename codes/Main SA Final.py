...
data = pd.read_csv('C:\\Users\\Preetham G\\Downloads\\RFR_test.csv')
name = ['RFR', 'ETR', 'BAR', 'GBR', 'XGBR']
comb_names = []
...
print(df)
df.to_csv('C:\\Users\\Preetham G\\Documents\\Research Projects\\Ensemble Rainfall\\Results\\Main - SA Final.csv', index=False)