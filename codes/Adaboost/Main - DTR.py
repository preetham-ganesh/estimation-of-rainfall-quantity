...
d['EVS'] = evs_f
d['R2'] = r2_f
df = pd.DataFrame(d, columns=['Max Depth', 'MSE', 'RMSE', 'MAE', 'MDAE', 'EVS', 'R2'])
df.to_csv('C:\\Users\\Preetham G\\Documents\\Research Projects\\Ensemble Rainfall\\Results\\Main - DTR.csv', index=False)